  ...
  const initPay= (order)=>{
    const options={
      ...
      handler:async(response)=>{
        try {
          const responce=await axios.post(backendUrl+'/api/order/verifyRazorpay',response,{headers:{token}})
      ...
      switch(method){
        ...
        case 'cod':
          ...
          case 'razorpay':
            ...
            if(responceRazorpay.data.sucess){
              initPay(responce.data.order)
            }
          break;
        default:
        break;
        ...
        <div className='mt-8'>
          ...
          <div className='mt-12 '>
            ...
            <div className='flex gap-3 flex-col lg:flex-row'>
              ...
              <div onClick={()=>setMethod('razo')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                <p className={`min-w-3.5 h-3.5 border rounded-full ${method==='razo'?'bg-green-400':''}`}></p>
